...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]Termiakasih atas luka yang kamu berikan ke pada ku/EGI PRIVASI-XD",width=90,title=f"[bold green]Thanks To",padding=(0,5),style=f"bold white"))
